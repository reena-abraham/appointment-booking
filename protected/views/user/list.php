<div class="p-4 bg-white block sm:flex items-center justify-between border-b border-gray-200 lg:mt-1.5">
	<div class="mb-1 w-full">
				...
				<ol class="inline-flex items-center space-x-1 md:space-x-2">
					...
					<li>
						<div class="flex items-center">
							...
							<span class="text-gray-400 ml-1 md:ml-2 text-sm font-medium" aria-current="page">Users</span>
						</div>
					</li>
				</ol>
			</nav>
		...
		<div class="block sm:flex items-center md:divide-x md:divide-gray-100" style="display:none">
...
$this->widget('zii.widgets.grid.CGridView', array(
    ...
    'columns' => array(
        ...
        array(
           'class' => 'CButtonColumn',
            'template' => '{view} {update} {delete}',  // Display View, Update, and Delete buttons
            'buttons' => array(
                'view' => array(
                    'label' => '<svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M10 3a7 7 0 00-7 7c0 1.248.56 2.496 1.55 3.556C4.226 13.504 3 15.104 3 17h14c0-1.896-1.226-3.496-3.55-5.444C16.44 12.496 17 11.248 17 10a7 7 0 00-7-7zm0 10a3 3 0 110-6 3 3 0 010 6z" clip-rule="evenodd"></path></svg> View',
                    'imageUrl' => false,  // No image
                   'url' => 'Yii::app()->createUrl("user/details", array("userId" => $data->id))',// Correct dynamic URL generation
                    'options' => array(
                        'class' => 'text-white bg-cyan-600 hover:bg-blue-700 focus:ring-4 focus:ring-blue-200 font-medium rounded-lg text-sm px-3 py-1 inline-flex items-center space-x-1',
                        'title' => 'View',
                        'escape' => false,
                    ),
                ),
        'update' => array(
            'label' => '<svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                        ...
                        </svg> Edit',  // Edit button configuration
            'imageUrl' => false,
            'options' => [
        ...
        'delete' => array(
            'label' => '<svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                        ...
                        </svg> Delete',  // Delete button configuration
            'imageUrl' => false,
            'options' => [
